...
The worker will be live at `https://dml-bps-mcp.<your-subdomain>.workers.dev`.
...
```bash
curl https://dml-bps-mcp.<your-subdomain>.workers.dev/mcp \
...
```json
{
  "mcpServers": {
    "dml-bps-mcp": {
      "type": "http",
      "url": "https://dml-bps-mcp.<your-subdomain>.workers.dev/mcp",
      "headers": {
...
```bash
claude mcp add --transport http bps https://dml-bps-mcp.<your-subdomain>.workers.dev/mcp
```

## Health Check

```bash
curl https://dml-bps-mcp.<your-subdomain>.workers.dev/
```
